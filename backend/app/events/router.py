...
(coordinator review queue), stories 4.4/4.5 (approve / reject an event request), and story 4.6 (the decision /
clarification history an organiser sees), and story 7.2 (routine information edits).."""
